...
$ helm install my-release riftbit/vertical-pod-autoscaler
```
...
```bash
$ helm upgrade my-release riftbit/vertical-pod-autoscaler
```
...
$ helm install my-release \
    --set nameOverride=my-name riftbit/vertical-pod-autoscaler
```
...
```bash
$ helm install my-release \
    --values values.yaml riftbit/vertical-pod-autoscaler
```
