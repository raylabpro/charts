...
$ helm install my-release riftbit/kubeview
```
...
```bash
$ helm upgrade my-release riftbit/kubeview
```
...
$ helm install my-release \
    --set replicaCount=3 riftbit/kubeview
```
...
```bash
$ helm install my-release \
    --values values.yaml riftbit/kubeview
```
